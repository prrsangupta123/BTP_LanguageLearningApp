...
public class Score5 extends AppCompatActivity {
    int score=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        V.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),Bar5.class));
    ...
    public void display(){
        ...
        DatabaseReference reference3=reference2.child("Questions");
        ...
        reference3.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Score5.this, "Fail to get data.", Toast.LENGTH_SHORT).show();
            }
        });
    }
