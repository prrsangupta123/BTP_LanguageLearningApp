...
public class RTest3 extends AppCompatActivity {
    ...
    public void openGame5x4Activity(){
        Intent intent5x4 = new Intent(this, RGame5x4Activity.class);
        startActivity(intent5x4);
    }

    public void openGame6x5Activity(){
        Intent intent6x5 = new Intent(this, RGame4x4Activity.class);
        startActivity(intent6x5);
    }

    public void openGameMatch3Activity(){
        Intent intentMatch3 = new Intent(this, RGameMatch3Activity.class);
