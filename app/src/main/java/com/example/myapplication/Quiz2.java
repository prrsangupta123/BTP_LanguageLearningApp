...
public class Quiz2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btOpt1 = findViewById(R.id.btOpt5);
        btOpt2 = findViewById(R.id.btOpt6);
        btOpt3 = findViewById(R.id.btOpt7);
        btOpt4 = findViewById(R.id.btOpt8);
    ...
    private void getDataFromAPI1(int n) {
        ...
        myref1.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Quiz2.this, "Fail to get data.", Toast.LENGTH_SHORT).show();
            }
        });
