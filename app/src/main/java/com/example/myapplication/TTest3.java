...
public class TTest3 extends AppCompatActivity {
    ...
    public void openGame5x4Activity(){
        Intent intent5x4 = new Intent(this, TGame5x4Activity.class);
        startActivity(intent5x4);
    }

    public void openGame6x5Activity(){
        Intent intent6x5 = new Intent(this, TGame4x4Activity.class);
        startActivity(intent6x5);
    }

    public void openGameMatch3Activity(){
        Intent intentMatch3 = new Intent(this, TGameMatch3Activity.class);
