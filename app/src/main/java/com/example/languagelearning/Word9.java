...
public class Word9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(getApplicationContext(),Word10.class));
    ...
    private void getDataFromAPI() {
        ...
        RequestQueue queue = Volley.newRequestQueue(Word9.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Word9.this, "Fail to get data..", Toast.LENGTH_SHORT).show();
            }
        });
