...
public class Quiz4 extends AppCompatActivity {
    ...
    private void getDataFromAPI() {
        ...
        String url ="https://script.googleusercontent.com/macros/echo?user_content_key=m62xy-Z-zMuuetvI2qPVCN8Ymj3m3VexG0G17YH5mHqhBbk5OU22hJ0rLXCDObSgaJZk4VkE6Rx2Hl-zBFmxjIJEWqSktMomOJmA1Yb3SEsKFZqtv3DaNYcMrmhZHmUMWojr9NvTBuBLhyHCd5hHa1GhPSVukpSQTydEwAEXFXgt_wltjJcH3XHUaaPC1fv5o9XyvOto09QuWI89K6KjOu0SP2F-BdwUJJbN7MxLSqfIfKRzvx-FkDL_yPQqz0pBf0CqjwXfvGYxBTTVu962N2uHADTQdpyr5y7FLqOV0TlbHvop0eFgCg&lib=MnrE7b2I2PjfH799VodkCPiQjIVyBAxva";
        ...
        RequestQueue queue = Volley.newRequestQueue(Quiz4.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    JSONArray entryArray = response.getJSONArray("Sheet4");
                    ...
                    tm = new CountDownTimer(12 * 1000, 1000) {
                        ...
                        public void onFinish() {
                            ...
                            Toast.makeText(Quiz4.this, "Quiz Over", Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Quiz4.this, "Fail to get data..", Toast.LENGTH_LONG).show();
            }
        });
        ...
        btOpt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (btOpt1.getText().equals(q.getRightOpt())) {
                    Toast.makeText(Quiz4.this, "Correct Answer", Toast.LENGTH_LONG).show();
                    if (conter < (queList.size() - 1)) {
                        ...
                        Toast.makeText(Quiz4.this, "All Que Completed!", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(Quiz4.this, "Wrong Answer", Toast.LENGTH_LONG).show();
                    if (conter < (queList.size() - 1)) {
                        //tm.cancel();
                        conter++;
                        loadQuetions(conter);
