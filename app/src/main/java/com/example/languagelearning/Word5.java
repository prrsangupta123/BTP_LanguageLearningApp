...
public class Word5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(getApplicationContext(),Word6.class));
    ...
    private void getDataFromAPI() {
        ...
        RequestQueue queue = Volley.newRequestQueue(Word5.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Word5.this, "Fail to get data..", Toast.LENGTH_SHORT).show();
            }
        });
