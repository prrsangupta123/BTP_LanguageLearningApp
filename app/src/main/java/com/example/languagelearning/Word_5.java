...
public class Word_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_word_5);
    ...
    private void getDataFromAPI() {
        ...
        String url= "https://script.googleusercontent.com/macros/echo?user_content_key=0tfW6x3I2QXnjr1XeJ7xqP1iskVD2m0sMZp3eUWdo4oy34k3k_T-rFLcSxc8Kf0sKJGBixOLWPY5OXgvCTBnJ0EmdCk7AiDaOJmA1Yb3SEsKFZqtv3DaNYcMrmhZHmUMWojr9NvTBuBLhyHCd5hHa1GhPSVukpSQTydEwAEXFXgt_wltjJcH3XHUaaPC1fv5o9XyvOto09QuWI89K6KjOu0SP2F-BdwUJJbN7MxLSqfIfKRzvx-FkDL_yPQqz0pBf0CqjwXfvGYxBTTVu962N2uHADTQdpyr5y7FLqOV0TmOdRNbgKvOpg&lib=MnrE7b2I2PjfH799VodkCPiQjIVyBAxva";
        ...
        RequestQueue queue = Volley.newRequestQueue(Word_5.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Word_5.this, "Fail to get data..", Toast.LENGTH_LONG).show();
            }
        });
