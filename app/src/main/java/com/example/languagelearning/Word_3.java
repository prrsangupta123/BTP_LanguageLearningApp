...
public class Word_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_word_3);
    ...
    private void getDataFromAPI() {
        ...
        String url= "https://script.googleusercontent.com/macros/echo?user_content_key=2tSuS1fGn1UK2JZp_03HmUlr2yPdxx1rqBfBJJNx3LTVOlg38aMxAG360OFLX3RWujpmQAKZKE0gy4-K5yD9_cMaIg1VTTVHOJmA1Yb3SEsKFZqtv3DaNYcMrmhZHmUMWojr9NvTBuBLhyHCd5hHa1GhPSVukpSQTydEwAEXFXgt_wltjJcH3XHUaaPC1fv5o9XyvOto09QuWI89K6KjOu0SP2F-BdwUJJbN7MxLSqfIfKRzvx-FkDL_yPQqz0pBf0CqjwXfvGYxBTTVu962N2uHADTQdpyr5y7FLqOV0Tm9hrVxdOpBlA&lib=MnrE7b2I2PjfH799VodkCPiQjIVyBAxva";
        ...
        RequestQueue queue = Volley.newRequestQueue(Word_3.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Word_3.this, "Fail to get data..", Toast.LENGTH_LONG).show();
            }
        });
