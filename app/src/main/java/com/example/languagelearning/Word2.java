...
public class Word2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(getApplicationContext(),Word3.class));
    ...
    private void getDataFromAPI() {
        ...
        RequestQueue queue = Volley.newRequestQueue(Word2.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Word2.this, "Fail to get data..", Toast.LENGTH_SHORT).show();
            }
        });
