...
public class Quiz2 extends AppCompatActivity {
    ...
    private void getDataFromAPI() {
        ...
        String url ="https://script.googleusercontent.com/macros/echo?user_content_key=f5R4EUcrI-dSnAvWMJ_lCitdIU0MsGx7HzPyoXyqYZB9rzwmBfC46T0xiXSHcLHCTvmnCR0ip6D547ZdDQfZc6I8L7jdn-E4OJmA1Yb3SEsKFZqtv3DaNYcMrmhZHmUMWojr9NvTBuBLhyHCd5hHa1GhPSVukpSQTydEwAEXFXgt_wltjJcH3XHUaaPC1fv5o9XyvOto09QuWI89K6KjOu0SP2F-BdwUJJbN7MxLSqfIfKRzvx-FkDL_yPQqz0pBf0CqjwXfvGYxBTTVu962N2uHADTQdpyr5y7FLqOV0TlFsndg6uoYug&lib=MnrE7b2I2PjfH799VodkCPiQjIVyBAxva";
        ...
        RequestQueue queue = Volley.newRequestQueue(Quiz2.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    JSONArray entryArray = response.getJSONArray("Sheet2");
                    ...
                    tm = new CountDownTimer(12 * 1000, 1000) {
                        ...
                        public void onFinish() {
                            ...
                            Toast.makeText(Quiz2.this, "Quiz Over", Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Quiz2.this, "Fail to get data..", Toast.LENGTH_LONG).show();
            }
        });
        ...
        btOpt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (btOpt1.getText().equals(q.getRightOpt())) {
                    Toast.makeText(Quiz2.this, "Correct Answer", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(Quiz2.this, "Wrong Answer", Toast.LENGTH_LONG).show();
                    if (conter < (queList.size() - 1)) {
                        //tm.cancel();
                        conter++;
                        loadQuetions(conter);
