...
public class Word_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_word_4);
    ...
    private void getDataFromAPI() {
        ...
        RequestQueue queue = Volley.newRequestQueue(Word_4.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Word_4.this, "Fail to get data..", Toast.LENGTH_LONG).show();
            }
        });
